...
- (void) setup {
    ...
    backgroudImageView.image = [UIImage imageNamed:@"air"];
    backgroudImageView.contentMode = UIViewContentModeScaleAspectFill;
...
-(void) createPlanes {
    for (int i = 1; i < 6; i++) {
        UIImageView *plane = [[UIImageView alloc] initWithFrame:CGRectMake(-50.0, ((float)i * 50.0) +
                                                                          100.0, 50.0, 50.0)];
        plane.tag = i;
